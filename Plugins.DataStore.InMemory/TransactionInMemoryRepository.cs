...
namespace Plugins.DataStore.InMemory
{
    public class TransactionInMemoryRepository : ITransactionRepository
    {
        ...
        {
            Transaction transactionToDelete = transactions.Find(p => p.TransactionId == transactionId);
        ...
        public void Save(string cashierName, int productId, string productName, double price, int beforeQty, int soldQty, bool IsForSell = false)
        {
            int transactionId = 0;
